...
import getRandomEmoji from './random_emoji.jsx'
    ...
    <div className={`lg:flex lg:flex-col lg:justify-center lg:items-center md:hidden `} style={{opacity:opacity_screen}}>
      <div className=' lg:w-[95%] xl:w-[95%] lg:mx-auto rounded-3xl lg  lg:flex lg:mb-10 lg:flex-col '>
        ...
        <div className='xl:relative lg:relative xl:z-10   md:flex md:flex-row '>
          <div className='md:flex md:flex-row md:gap-10 mx-20 pt-10'>
          <div className=' md:flex md:flex-col md:gap-4 '>
            
             <button > <img src={Janu} alt="" className='w-20 h-20  hover:bg-[var(--bg-hover)]  hover:animate-pulse   hover:duration-500' style={{'--bg-hover': monCol}} 
             onClick={() => {
              setJanshow(true)
              console.log(showJan)
