...
import red from "../../assets/tasklistfolder_gfx/red.png"
import blue from "../../assets/tasklistfolder_gfx/blue.png"
import green from "../../assets/tasklistfolder_gfx/green.png"
import yellow from "../../assets/tasklistfolder_gfx/yellow.png"
...
const Tasklist = () => {
  const {accept,reject,complete,totalquests} = useContext(TasksContext)
      ...
      <div className='hidden lg:block flex-col justify-start items-start xl:flex xl:flex-row xl:w-[100%] h-auto gap-5 xl:gap-auto '>
        <div className='relative xl:hover:translate-y-2  duration-500 '>
          ...
          <div className='absolute xl:top-40 xl:left-15 top-22 left-8  '>
            <h1 className='relative text-white xl:bottom-8 xl:left-15 xl:text-7xl md:left-1 text-5xl bottom-6 left-13 play'>{totalquests}</h1>
            <h1 className='xl:text-2xl text-sm text-white play lg:text-red-800'>Total Quests</h1>
          </div>
      ...
      <div className='lg:hidden  flex flex-row px-5 justify-between '>
        <div className='bg-red-500 md:px-10 sm:px-5 px-2 border-2 border-red-800 flex flex-col items-center  rounded-tr-4xl '>
          ...
          <div className='sm:flex sm:flex-col sm:justify-center sm:items-center flex flex-col justify-center items-center '>
            <h1 className='text-white play px-2 sm:px-0'>{totalquests}</h1>
            <h1 className='text-white play py-2'>Total Quests</h1>
